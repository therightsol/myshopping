        ...
        <div class="col-md-12">
            ...
            <div>
                <form action="#" method="post" class="form-inline">
                    ...
                    <label for="age"  style="margin-left:80px;">Age:</label>

                    <input type="text" name="age" class="form-control" >

                    <label for="gender"  style="margin-left: 80px;">Sex:</label>
                    ...
                    <label for="contact"  style="margin-left: 80px;">Contact:</label>
                    ...
                    <label for="contact"  style="margin-left: 80px;">Order Status:</label>

                    <input type="text" name="contact" class="form-control" > <br>

                    <label for="contact"  style="">Shipping Address:</label>

                    <input type="text" name="contact" class="form-control" style="width: 79.5%;margin-top: 10px;"> <br>

                    <label for="contact"  style="">Shipping Method:</label>
            ...
            <form action="#" method="post" class="form-inline" style="float: right;margin-right: 65px">

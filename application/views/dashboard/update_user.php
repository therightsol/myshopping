                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <?php  foreach ($r as $row): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo $root;?>dashboard/view_update_specificRecord2/<?php   echo $row['id'];   ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>UPDATE</a></td>

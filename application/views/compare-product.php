                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-striped compare-item-table">
                            <tr>
                                ...
                                <td>
                                    <figure><a href="compare-products.html#"><img src="<?php echo $root; ?>assets/images/products/compare1.jpg"
                                                                                  alt="Lowlands Lace Blouse"></a>
                                    </figure>
                                    <p class="item-name"><a href="compare-products.html#">Lowlands Lace Blouse</a>
                                    </p></td>
                                <td>
                                    <figure><a href="compare-products.html#"><img src="<?php echo $root; ?>assets/images/products/compare2.jpg"
                                                                                  alt="Samsung Galaxy Ace"></a>
                                    </figure>
                                    <p class="item-name"><a href="compare-products.html#">Samsung Galaxy Ace</a></p>
                                </td>
                                <td>
                                    <figure><a href="compare-products.html#"><img src="<?php echo $root; ?>assets/images/products/compare3.jpg"
                                                                                  alt="Iphone Case Cover"></a>
                                    </figure>
                                    <p class="item-name"><a href="compare-products.html#">Iphone Case Cover</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-title">PRICE</td>
                                <td><span class="item-price-special">$130</span></td>
                                <td><span class="item-price-special">$599</span></td>
                                <td><span class="item-price-special">$399</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Sed ac lacus magna. In pulvinar diam diam, et lobortis massa tincidunt id.
                                    Quisque porttitor venenatis dolor sit amet sodales. Aliquam ligula erat.
                                </td>
                                <td>Curabitur convallis et sem at cursus. Fusce fringilla feugiat dictum. Cras non
                            ...
                            <tr>
                                ...
                                <td>21 cm x 32 cm x 61 cm</td>
                                <td>33 cm x 22 cm x 48 cm</td>
                            </tr>
                            <tr>
                                <td class="table-title"></td>
                                <td><a href="compare-products.html#" class="btn btn-custom-2">Add to Cart</a>

                                    <div class="sm-margin"></div>
                                    <a href="compare-products.html#" class="close-button"></a></td>
                                <td><a href="compare-products.html#" class="btn btn-custom-2">Add to Cart</a>

                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-striped compare-item-table">
                            <tr>
                                ...
                                <td>
                                    <figure><a href="compare-products.html#"><img src="images/products/compare1.jpg"
                                                                                  alt="Lowlands Lace Blouse"></a>
                                    </figure>
                                    <p class="item-name"><a href="compare-products.html#">Lowlands Lace Blouse</a>
                                    </p></td>
                                <td>
                                    <figure><a href="compare-products.html#"><img src="images/products/compare2.jpg"
                                                                                  alt="Samsung Galaxy Ace"></a>
                                    </figure>
                                    <p class="item-name"><a href="compare-products.html#">Samsung Galaxy Ace</a></p>
                                </td>
                                <td>
                                    <figure><a href="compare-products.html#"><img src="images/products/compare3.jpg"

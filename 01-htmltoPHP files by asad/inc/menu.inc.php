                        ...
                        <div class="col-md-12 clearfix">
                            <nav id="main-nav">
                                ...
                                <ul class="menu clearfix">
                                    ...
                                    <li class="mega-menu-container"><a href="index.html#">SHOP</a>

                                        <div class="mega-menu clearfix">
                                            <div class="col-5"><a href="category.html"
                                                                  class="mega-menu-title">Clothing</a>
                                                <ul class="mega-menu-list clearfix">
                                                    <li><a href="index.html#">Dresses</a></li>
                                                    <li><a href="index.html#">Jeans &amp; Trousers</a></li>
                                                    <li><a href="index.html#">Blouses &amp; Shirts</a></li>
                                                    <li><a href="index.html#">Tops &amp; T-Shirts</a></li>
                                            ...
                                            <div class="col-5"><a href="category.html" class="mega-menu-title">Shoes</a>
                                                <ul class="mega-menu-list clearfix">
                                                    <li><a href="index.html#">Formal Shoes</a></li>
                                                    <li><a href="index.html#">Casual Shoes</a></li>
                                                    <li><a href="index.html#">Sandals</a></li>
                                                    <li><a href="index.html#">Boots</a></li>
                                                    <li><a href="index.html#">Wide Fit</a></li>
                                                    <li><a href="index.html#">Slippers</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-5"><a href="category.html" class="mega-menu-title">Accessories</a>
                                                <ul class="mega-menu-list clearfix">
                                                    <li><a href="index.html#">Bags &amp; Purses</a></li>
                                                    ...
                                                    <li><a href="index.html#">Hair Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-5"><a href="category.html"
                                                                  class="mega-menu-title">Sports</a>
                                                <ul class="mega-menu-list clearfix">
                                                    <li><a href="index.html#">Sport Tops &amp; Vests</a></li>
                                                    <li><a href="index.html#">Swimwear</a></li>
                                                    <li><a href="index.html#">Footwear</a></li>
                                                    <li><a href="index.html#">Sports Underwear</a></li>
                                            ...
                                            <div class="col-5"><a href="category.html"
                                                ...
                                                <ul class="mega-menu-list clearfix">
                                                    <li><a href="index.html#">Tops &amp; Skirts</a></li>
                                                    <li><a href="index.html#">Dresses</a></li>
                                                    <li><a href="index.html#">Trousers &amp; Shorts</a></li>
                                                    <li><a href="index.html#">Knitwear</a></li>
                                                    <li><a href="index.html#">Jackets &amp; Coats</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li><a href="index.html#">PAGES</a>
                                        <ul>
                                            ...
                                            <li><a href="index.html#">Footers</a>
                                                <ul>
                                    ...
                                    <li><a href="index.html#">Portfolio</a>
                                        <ul>
                                            <li><a href="index.html#">Classic</a>
                                                <ul>
                                            ...
                                            <li><a href="index.html#">Masonry</a>
                                                <ul>
                                            ...
                                            <li><a href="index.html#">Portfolio Posts</a>
                                                <ul>
                            ...
                            <div id="quick-access">
                                    ...
                                    <div class="btn-group dropdown-cart">
                                        ...
                                        <div class="dropdown-menu dropdown-cart-menu pull-right clearfix" role="menu"><p
                                            ...
                                            <ul class="dropdown-cart-product-list">
                                                <li class="item clearfix"><a href="index.html#" title="Delete item"
                                                                             class="delete-item"><i
                                                        class="fa fa-times"></i></a> <a href="index.html#"
                                                                                        title="Edit item"
                                                                                        class="edit-item"><i
                                            ...
                                            <div class="dropdown-cart-action"><p><a href="cart.html"
                                ...
                                <form class="form-inline quick-search-form" role="form" action="index.html#">

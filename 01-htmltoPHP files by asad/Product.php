                        ...
                        <div id="product-image-carousel-container">
                            <ul id="product-carousel" class="celastislide-list">
                                <li class="active-slide"><a data-rel="prettyPhoto[product]"
                                            ...
                                            src="images/products/thumbnails/item10.jpg" alt="Phone photo 1"></a></li>
                                <li><a data-rel="prettyPhoto[product]" href="images/products/big-item2.jpg"
                                       ...
                                       data-zoom-image="images/products/big-item2.jpg" class="product-gallery-item"><img
                                            src="images/products/thumbnails/item11.jpg" alt="Phone photo 2"></a></li>
                                <li><a data-rel="prettyPhoto[product]" href="images/products/big-item3.jpg"
                                       ...
                                       data-zoom-image="images/products/big-item3.jpg" class="product-gallery-item"><img
                                            src="images/products/thumbnails/item12.jpg" alt="Phone photo 3"></a></li>
                                <li><a data-rel="prettyPhoto[product]" href="images/products/big-item4.jpg"
                                       ...
                                       data-zoom-image="images/products/big-item4.jpg" class="product-gallery-item"><img
                                            src="images/products/thumbnails/item13.jpg" alt="Phone photo 4"></a></li>
                                <li><a data-rel="prettyPhoto[product]" href="images/products/big-item5.jpg"
                                       ...
                                       data-zoom-image="images/products/big-item5.jpg" class="product-gallery-item"><img
                                            src="images/products/thumbnails/item14.jpg" alt="Phone photo 4"></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 product">
                        ...
                        <div class="ratings-container">
                            ...
                            <span class="ratings-amount separator">3 Review(s)</span> <span
                                class="separator">|</span> <a href="product.html#review" class="rate-this">Add Your
                                Review</a></div>
                        ...
                        <div class="product-color-filter-container"><span>Select Color:</span>
                            ...
                            <ul class="filter-color-list clearfix">
                                <li><a href="product.html#" data-bgcolor="#fff" class="filter-color-box"></a></li>
                                <li><a href="product.html#" data-bgcolor="#d1d2d4" class="filter-color-box"></a>
                                </li>
                                <li><a href="product.html#" data-bgcolor="#666467" class="filter-color-box"></a>
                                </li>
                                <li><a href="product.html#" data-bgcolor="#515151" class="filter-color-box"></a>
                                </li>
                                <li><a href="product.html#" data-bgcolor="#bcdae6" class="filter-color-box"></a>
                                </li>
                                <li><a href="product.html#" data-bgcolor="#5272b3" class="filter-color-box"></a>
                                </li>
                                <li><a href="product.html#" data-bgcolor="#acbf0b" class="filter-color-box"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="product-size-filter-container"><span>Select Size:</span>
                            ...
                            <ul class="filter-size-list clearfix">
                                <li><a href="product.html#">XS</a></li>
                                <li><a href="product.html#">S</a></li>
                                <li><a href="product.html#">M</a></li>
                                <li><a href="product.html#">L</a></li>
                                <li><a href="product.html#">XL</a></li>
                            </ul>
                        </div>
                        <hr>
                        <div class="product-add clearfix">
                            <div class="custom-quantity-input"><input type="text" name="quantity" value="1"> <a
                                    href="product.html#" onclick="return!1"
                        ...
                        <div class="product-extra clearfix">
                            <div class="product-extra-box-container clearfix">
                                <div class="item-action-inner"><a href="product.html#"
                                                                  class="icon-button icon-like">Favourite</a> <a
                                        href="product.html#" class="icon-button icon-compare">Checkout</a></div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <div class="tab-container left product-detail-tab clearfix">
                            <ul class="nav-tabs">
                                <li class="active"><a href="product.html#overview" data-toggle="tab">Overview</a>
                                </li>
                                <li><a href="product.html#description" data-toggle="tab">Description</a></li>
                                <li><a href="product.html#review" data-toggle="tab">Review</a></li>
                                <li><a href="product.html#additional" data-toggle="tab">Additional Info</a></li>
                                <li><a href="product.html#video" data-toggle="tab">Video</a></li>
                            </ul>
                    ...
                    <div class="purchased-items-slider owl-carousel">
                        <div class="item item-hover">
                            ...
                            <div class="item-meta-container">
                                ...
                                <div class="item-action"><a href="product.html#" class="item-add-btn"><span
                        ...
                        <div class="item item-hover">
                            <div class="item-image-wrapper">
                                <figure class="item-image-container"><a href="product.html"><img
                                            src="images/products/item10.jpg" alt="item1" class="item-image"> <img
                                            src="images/products/item10-hover.jpg" alt="item1  Hover"
                                            class="item-image-hover"></a></figure>
